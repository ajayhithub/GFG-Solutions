<h2><a href="https://practice.geeksforgeeks.org/problems/maximum-sub-array5443/1?page=4&difficulty[]=1&category[]=Arrays&category[]=Strings&sortBy=submissions">Maximum Sub Array</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Find out the maximum sub-array of non negative numbers from an array.</span></p>
