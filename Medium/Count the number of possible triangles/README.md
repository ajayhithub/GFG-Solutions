<h2><a href="https://practice.geeksforgeeks.org/problems/count-possible-triangles-1587115620/1?page=3&difficulty[]=1&category[]=Arrays&category[]=Strings&sortBy=submissions">Count the number of possible triangles</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an unsorted array <strong>arr[]&nbsp;</strong>of <strong>n</strong> positive integers. Find the number of triangles that can be formed with three different array elements as lengths of three sides of triangles.&nbsp;</span></p>
