<h2><a href="https://practice.geeksforgeeks.org/problems/check-for-subsequence4930/1?page=1&difficulty[]=-1&category[]=Strings&sortBy=submissions">Check for subsequence</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings A and B, find if A is a subsequence of B.</span></p>
