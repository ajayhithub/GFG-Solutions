<h2><a href="https://practice.geeksforgeeks.org/problems/equal-left-and-right-subarray-sum--170647/1?page=6&difficulty[]=0&category[]=Arrays&category[]=Strings&sortBy=submissions">Equal Left and Right Subarray Sum</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array A of n&nbsp;positive numbers. The task is to find the first index in the array such that&nbsp;the sum of elements before it is equal to the sum of elements after it.</span></p>
